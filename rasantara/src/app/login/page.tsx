      ...
      <main className="flex-grow flex items-center justify-center px-4 mb-50">
        <div className="w-full max-w-md">
          ...
          <button
            ...
            className="w-full bg-white border border-gray-300 text-gray-700 py-2 px-4 rounded-md hover:bg-[#E0A106] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 flex items-center justify-center gap-3 transition-colors"
          >
