...
export default function Footer() {
  return (
    ...
    <footer className="relative z-40 bg-[#5C4033] py-6 px-4 sm:py-8 mt-auto">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-6 sm:gap-8 mb-6">
          ...
          <div className="flex flex-col items-center sm:items-start space-y-2 flex-1">
            <h3 className="text-lg font-bold text-[#FAFAFA]">Rasantara</h3>
            <p className="text-sm text-[#FAFAFA] text-center sm:text-left max-w-xs">
          ...
          <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6 sm:gap-8 flex-1 sm:justify-center">
            <div className="flex flex-col items-center sm:items-start space-y-2">
              <h4 className="font-semibold text-[#FAFAFA] text-sm mb-1">Menu</h4>
              <Link
                href="/"
                className="flex items-center gap-2 text-white hover:text-[#FAFAFA] transition-colors text-sm"
              >
          ...
          <div className="flex flex-col items-center sm:items-start space-y-2 flex-1 sm:justify-end">
            <h4 className="font-semibold text-[#FAFAFA] text-sm mb-1">Collaboration</h4>
            <p className="text-xs text-[#FAFAFA] text-center sm:text-left">
        ...
        {/* Copyright */}
        <div className="flex flex-col sm:flex-row sm:justify-between items-center gap-2 text-xs text-[#FAFAFA]">
